...
create_project = for i in 1..5 do
  ...
  backer_quantity: 3, category_id: i ])
end
...
create_order1 = for j in 1..3 do
    ...
    BillPayment.create(order_id: j, channel_id: 0,
...
backer_quantity: 1, category_id: 1 ])
...
backer_quantity: 1, category_id: 2 ])
...
backer_quantity: 1, category_id: 3])
...
puts "9 User's Plan created."
  ...
  BillPayment.create(order_id: 17, channel_id: 0,
